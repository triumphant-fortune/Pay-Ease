...
class SDK {
     ...
     */
    authController_generateApiKeySecret() {
     ...
     */
    depositCardController_cardDeposit(body) {
     ...
     */
    depositCardController_getWithdrawalStatus(metadata) {
     ...
     */
    depositCryptoIntegratorController_createCryptoDeposit(body) {
        return this.core.fetch('/api/v3/deposit/crypto', 'post', body);
    }
    /**
     ...
     */
    depositCryptoIntegratorController_getCryptoDepositStatus(metadata) {
        return this.core.fetch('/api/v3/deposit/crypto/status/{reference_id}', 'get', metadata);
    }
    /**
     ...
     */
    withdrawTransactionController_getSupportingBanksWithCurrency(metadata) {
     ...
     */
    offRampController_getIntegratorOfframps() {
        return this.core.fetch('/api/v3/offramp/transactions', 'get');
    }
    /**
     * This endpoint will return the status of the withdrawal request.
     *
     ...
     */
    offRampController_getCancelTransaction(metadata) {
     ...
     */
    offRampController_getRefundStatus(metadata) {
        return this.core.fetch('/api/v3/offramp/refund-status/{referenceId}', 'get', metadata);
    }
    /**
     ...
     */
    offRampController_retryRefund(metadata) {
        return this.core.fetch('/api/v3/offramp/retry-refund/{referenceId}', 'post', metadata);
    }
    /**
     ...
     */
    onrampController_getIntegratorOnramps() {
        return this.core.fetch('/api/v3/onramp/transactions', 'get');
    }
    /**
     ...
     */
    fiatToFiatController_generateInvoice(body) {
     ...
     */
    fiatToFiatController_getInvoice(metadata) {
     ...
     */
    fiatToFiatController_payInvoice(body) {
     ...
     */
    fiatToFiatController_getPaidInvoiceStatus(metadata) {
     ...
     * @summary Send SMS
     */
    smsController_sendSms(body) {
        return this.core.fetch('/api/v3/sms/send', 'post', body);
    }
    /**
     ...
     */
    smsController_registerWebhook(body) {
        return this.core.fetch('/api/v3/sms/clients', 'post', body);
    }
}
